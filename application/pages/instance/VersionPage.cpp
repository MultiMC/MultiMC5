...
void VersionPage::updateVersionControls()
{
    ...
    ui->actionInstall_Quilt->setEnabled(controlsEnabled && newCraft);
...
void VersionPage::on_actionChange_version_triggered()
{
    ...
    if (uid == "net.fabricmc.intermediary" || uid == "org.quiltmc.intermediary")
    {
...
{
    auto vlist = ENV.metadataIndex()->get("org.quiltmc.quilt-loader");
    if(!vlist)
    {
        return;
    }
